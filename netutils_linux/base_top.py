...
class BaseTop:
    ...
    def __init__(self):
        ...
        self.specific_options = [
            Option('-i', '--interval', default=1, type=int, dest='interval',
                   help='Interval between screen renew in seconds.'),
            Option('-n', '--iterations', '--iterations-number', dest='iterations', default=60, type=int,
            ...
            Option('-l', '--delta-small-hide-limit', default=80, type=int, dest='delta_small_hide_limit',
            ...
            Option('--spaces', dest='spaces', default=False, action='store_true',
